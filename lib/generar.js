...
function keyPara(tipo, slug) {
  if (tipo === "practice") return keyPractice(slug);
  if (tipo === "exam") return keyExam(slug);
  return keyFormulas(slug);
}
