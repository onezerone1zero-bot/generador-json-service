 ...
 * Claude crea -> valida forma -> Mistral corrige -> valida forma de
 * nuevo -> guarda en KV.
 *
 ...
 * Si Mistral falla por crédito/cuota, se sigue adelante con el borrador
 * de Claude tal cual (ya validado), en vez de abortar el job entero.
 */
