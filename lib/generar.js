...
import { leerJSON, escribirJSON, borrarJSON, keyPractice, keyExam, keyFormulas, keyVisual } from "./kv.js";
...
// La fórmula visual es una sola expresión corta (ideal <60 caracteres,
// tope duro de 400 -- ver formulaSegura.js), muchísimo más chica que el
// LaTeX de MAX_TOKENS_FORMULAS. Este número deja margen amplio de todos
// modos porque no está medido en producción todavía.
const MAX_TOKENS_VISUAL = 1000;
 ...
 */
export async function generarYGuardarJSON({ materia, tema, tipos = ["practice", "exam", "formula"], temaCanonico, idioma = "es" }) {
  if (!materia || !tema) {
